...
<div class="footer">
		<div class="container">
			<div class="w3_footer_grids">
				...
				<div class="col-md-3 w3_footer_grid">
					<h3>D Mart's</h3>
					<ul class="info"> 
						<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="{{ route('category') }}">Categories</a></li>
						<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="{{ route('company') }}">Comapnies</a></li>
						<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="{{ route('product') }}">Products</a></li>{{-- 
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>© 2019 D Mart. All rights reserved </p>{{-- | Design by <a href="http://w3layouts.com/">W3layouts</a></p> --}}
			</div>
		</div>
