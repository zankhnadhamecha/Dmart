...
<!-- Mirrored from colorlib.com//polygon/concept/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Jul 2019 12:16:17 GMT -->
...
<link rel="stylesheet" href="{{ asset('admin/fontawesome-all.css') }}">
<link rel="stylesheet" href="{{ asset('admin/chartist.css') }}">
<link rel="stylesheet" href="{{ asset('admin/morris.css') }}">
<link rel="stylesheet" href="{{ asset('admin/materialdesignicons.min.css') }}">
<link rel="stylesheet" href="{{ asset('admin/c3.css') }}">
<link rel="stylesheet" href="{{ asset('admin/flag-icon.min.css') }}">
...
<a class="navbar-brand" href="index-2.html">Concept</a>
...
<a class="nav-link nav-user-img" href="#" id="navbarDropdownMenuLink2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{{ asset('admin/avatar-1.jpg') }}" alt="" class="user-avatar-md rounded-circle"></a>
...
<a id="frm_logout" class="dropdown-item" href=""><i class="fas fa-power-off mr-2"></i>
Logout</a>
<form id="frm" method="post" action="{{ route('admin.logout') }}">
	@csrf
	</form>
</div>
</li>
...
<script>
	$(function(){
		$("#frm_logout").click(function(event){
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
<script src="{{ asset('admin/query-3.3.1.min.js') }}" type="1263167cb00211d254bc3321-text/javascript"></script>

<script src="{{ asset('admin/bootstrap.bundle.js') }} " type="1263167cb00211d254bc3321-text/javascript"></script>

<script src="{{ asset('admin/jquery.slimscroll.js') }}" type="1263167cb00211d254bc3321-text/javascript"></script>

<script src="{{ asset('admin/main-js.js') }}" type="1263167cb00211d254bc3321-text/javascript"></script>

{{-- <script src="{{ asset('admin/chartist.min.js') }}" type="1263167cb00211d254bc3321-text/javascript"></script> --}}

<script src="{{ asset('admin/jquery.sparkline.js') }}" type="1263167cb00211d254bc3321-text/javascript"></script>

<script src="{{ asset('admin/raphael.min.js') }}" type="1263167cb00211d254bc3321-text/javascript"></script>
<script src="{{ asset('admin/morris.js') }}" type="1263167cb00211d254bc3321-text/javascript"></script>

{{-- <script src="{{ asset('admin/c3.min.js') }}" type="1263167cb00211d254bc3321-text/javascript"></script> --}}
{{-- <script src="{{ asset('admin/d3-5.4.0.min.js') }}" type="1263167cb00211d254bc3321-text/javascript"></script> --}}
{{-- <script src="{{ asset('admin/C3chartjs.js') }}" type="1263167cb00211d254bc3321-text/javascript"></script> --}}
{{-- <script src="{{ asset('admin/dashboard-ecommerce.js') }}" type="1263167cb00211d254bc3321-text/javascript"></script> --}}

<script async src="https://www.googletagmanager.com/gtag/js?id=UA-23581568-13" type="1263167cb00211d254bc3321-text/javascript"></script>
<script type="1263167cb00211d254bc3321-text/javascript">
...
<script src="{{ asset('admin/rocket-loader.min.js') }}" data-cf-settings="1263167cb00211d254bc3321-|49" defer=""></script></body>

<!-- Mirrored from colorlib.com//polygon/concept/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Jul 2019 12:16:49 GMT -->
</html>